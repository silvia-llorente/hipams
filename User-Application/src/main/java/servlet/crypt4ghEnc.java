 ...
 * @author alumne
 */
@WebServlet(name = "crypt4ghEnc", urlPatterns = {"/crypt4ghEnc"})
@MultipartConfig
public class crypt4ghEnc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Part plainP = request.getPart("plain");
        ...
        StreamDataBodyPart plain = new StreamDataBodyPart("plain",plainP.getInputStream());
        ...
        try (FormDataMultiPart formDataMultiPart = new FormDataMultiPart()) {
            ...
            final WebTarget target = client.target(props.getProperty("workflowUrl") + "/api/v1/crypt4ghEnc");
            System.out.println("SERVLET crypt4ghEnc.java: "+ props.getProperty("workflowUrl") + "/api/v1/crypt4ghEnc");
        ...
        String filename = plainP.getName();
        response.setHeader("Content-disposition", "attachment; filename=cipher.c4gh");
