 ...
 * @author alumne
 */
@WebServlet(name = "deleteDataset", urlPatterns = {"/deleteDataset"})
@MultipartConfig
public class deleteDataset extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String res = "",aux;
        try {
            URL url = new URL(props.getProperty("workflowUrl") + "/api/v1/deleteDataset?dt_id=" + dt_id + "&dg_id=" + dg_id + "&mpegfile=" + mpegfile);
