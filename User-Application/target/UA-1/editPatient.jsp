...
<%
    ...
    writer.println(Prints.printHead("Edit Patient"));
    writer.println("<div class=\"container\">"
            + "    <h1>Edit Patient</h1>");
    if(request.getAttribute("success") != null && request.getAttribute("success").equals("true")){
        writer.println("<div class=\"card-panel green white-text\" text=\"${success}\">Patient edited successfully!</div>");
    }
    else if(request.getAttribute("success") != null) {
        writer.println("<div class=\"card-panel red white-text\" th:text=\"${error}\" th:if=\"${error}\">Error editing Patient.</div>");
    }
    ...
    writer.println("<div class=\"row\">"
            + "        <form  method=\"POST\" action=\"editPatient\" enctype=\"multipart/form-data\" class=\"col s12\">"
            + "            <div class=\"file-field input-field\">"
            + "                <div class=\"btn\">"
            + "                    <span>Select patient metadata</span>"
            + "                    <input type=\"file\" name=\"patient_md\" accept=\"text/xml\">"
            + "                </div>"
            ...
            + "            <div class=\"file-field input-field\">"
            + "                <div class=\"btn\">"
            + "                    <span>Select patient protection</span>"
